...
Trimming occurs in the order which the steps are specified on the command line. It is recommended to perform adapter clipping, if required, as early as possible in most cases.
